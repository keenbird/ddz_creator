...
var MouseEvent = /*#__PURE__*/function (_Event) {
  ...
  function MouseEvent(type) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MouseEvent).call(this, type));
  }
...
var PointerEvent = /*#__PURE__*/function (_Event) {
  ...
  function PointerEvent(type) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PointerEvent).call(this, type));
...
var HTMLMediaElement = /*#__PURE__*/function (_HTMLElement) {
  ...
  function HTMLMediaElement(tagName) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(HTMLMediaElement).call(this, tagName));
  }
...
if (window.__globalAdapter) {
  ...
  utils.cloneMethod(globalAdapter, swan, 'onMessage'); // Subpackage

  utils.cloneMethod(globalAdapter, swan, 'loadSubpackage'); // SharedCanvas
