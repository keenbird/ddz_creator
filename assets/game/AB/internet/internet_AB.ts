...
@ccclass('internet_AB')
export class internet_AB extends internet_GameBase {
    /**协议相关字段--began------------------------------------ */
    proto = proto.game_ab
    /**命令ID */
    cmd = this.proto.CMD
    ...
    MSG_BET_C(data: proto.game_ab.IMSG_BET_C) {
        this.sendMessage({
            cmd: this.cmd.MSG_BET_C,
            data: data,
        });
    }
    MSG_BACK_C(data: proto.game_ab.IMSG_BACK_C) {
        this.sendMessage({
            cmd: this.cmd.MSG_BACK_C,
            data: data,
        });
    }
    MSG_SYNCDATA_C(data: proto.game_ab.IMSG_SYNCDATA_C) {
        this.sendMessage({
            cmd: this.cmd.MSG_SYNCDATA_C,
            data: data,
        });
    ...
    MSG_RECONNECT_S(data: proto.game_ab.IMSG_RECONNECT_S) {
    ...
    GameRule(data: proto.game_ab.IGameRule) {
        //刷新房间配置
    ...
    GameReconnectRoom(data: proto.game_ab.IGameReconnectRoom) {
        return this.doReconnect(data);
    }
...
declare global {
    namespace globalThis {
        type type_internet_AB = internet_AB
    }
}
