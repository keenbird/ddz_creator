...
var XMLHttpRequest = /*#__PURE__*/function (_EventTarget) {
  ...
  _createClass(XMLHttpRequest, [{
    ...
    /* async, user, password. These parameters are not supported within the applet*/
    ) {
...
function inject() {
  ...
  var _my$getSystemInfoSync = my.getSystemInfoSync(),
      platform = _my$getSystemInfoSync.platform; // Developer tools cannot redefine window
